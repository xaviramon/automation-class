...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_EMEA_NORTH_01_SPINE1_Ethernet11 | routed | - | 172.31.1.128/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_EMEA_NORTH_01_SPINE2_Ethernet11 | routed | - | 172.31.1.130/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_EMEA_NORTH_02_SPINE1_Ethernet11 | routed | - | 172.31.2.128/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_EMEA_NORTH_02_SPINE2_Ethernet11 | routed | - | 172.31.2.130/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_EMEA_NORTH_01_SPINE1_Ethernet11
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_EMEA_NORTH_01_SPINE2_Ethernet11
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_EMEA_NORTH_02_SPINE1_Ethernet11
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_EMEA_NORTH_02_SPINE2_Ethernet11
   no shutdown
   mtu 1500
   no switchport
