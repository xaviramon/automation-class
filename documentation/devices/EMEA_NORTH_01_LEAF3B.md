...
| --------- | --------------- | ------------ | --------- |
| EMEA_NORTH_01_LEAF3 | Vlan4094 | 10.255.252.8 | Port-Channel12 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet12 | MLAG_PEER_EMEA_NORTH_01_LEAF3A_Ethernet12 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 12 |
| Ethernet13 | MLAG_PEER_EMEA_NORTH_01_LEAF3A_Ethernet13 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 12 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet10 | P2P_LINK_TO_EMEA_NORTH_01_SPINE1_Ethernet6 | routed | - | 172.31.255.41/31 | default | 1500 | false | - | - |
| Ethernet11 | P2P_LINK_TO_EMEA_NORTH_01_SPINE2_Ethernet6 | routed | - | 172.31.255.43/31 | default | 1500 | false | - | - |
...
interface Ethernet12
   description MLAG_PEER_EMEA_NORTH_01_LEAF3A_Ethernet12
   no shutdown
   channel-group 12 mode active
!
interface Ethernet13
   description MLAG_PEER_EMEA_NORTH_01_LEAF3A_Ethernet13
   no shutdown
   channel-group 12 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel12 | MLAG_PEER_EMEA_NORTH_01_LEAF3A_Po12 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel12
   description MLAG_PEER_EMEA_NORTH_01_LEAF3A_Po12
   no shutdown
   switchport
...
| 121 | 192.168.255.10:10121 | 10121:10121 | - | - | learned |
...
router bgp 65103
   ...
   neighbor 10.255.254.8 description EMEA_NORTH_01_LEAF3A
   neighbor 172.31.255.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.40 description EMEA_NORTH_01_SPINE1_Ethernet6
   neighbor 172.31.255.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.42 description EMEA_NORTH_01_SPINE2_Ethernet6
