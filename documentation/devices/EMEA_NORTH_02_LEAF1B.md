...
| --------- | --------------- | ------------ | --------- |
| EMEA_NORTH_02_LEAF1 | Vlan4094 | 10.255.252.0 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_EMEA_NORTH_02_LEAF1A_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet6 | MLAG_PEER_EMEA_NORTH_02_LEAF1A_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
!
interface Ethernet1
   description MLAG_PEER_EMEA_NORTH_02_LEAF1A_Ethernet1
   no shutdown
...
!
interface Ethernet6
   description MLAG_PEER_EMEA_NORTH_02_LEAF1A_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_EMEA_NORTH_02_LEAF1A_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_EMEA_NORTH_02_LEAF1A_Po1
   no shutdown
   switchport
