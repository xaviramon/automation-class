...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_EMEA_NORTH_01_SPINE1_Ethernet5 | routed | - | 172.31.255.13/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_EMEA_NORTH_01_SPINE2_Ethernet5 | routed | - | 172.31.255.15/31 | default | 1500 | false | - | - |
...
router bgp 65102
   ...
   neighbor 172.31.255.12 description EMEA_NORTH_01_SPINE1_Ethernet5
   neighbor 172.31.255.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.14 description EMEA_NORTH_01_SPINE2_Ethernet5
