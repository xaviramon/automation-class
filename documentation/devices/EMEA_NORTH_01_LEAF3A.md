...
| --------- | --------------- | ------------ | --------- |
| EMEA_NORTH_01_LEAF3 | Vlan4094 | 10.255.252.9 | Port-Channel12 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet12 | MLAG_PEER_EMEA_NORTH_01_LEAF3B_Ethernet12 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 12 |
| Ethernet13 | MLAG_PEER_EMEA_NORTH_01_LEAF3B_Ethernet13 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 12 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet10 | P2P_LINK_TO_EMEA_NORTH_01_SPINE1_Ethernet5 | routed | - | 172.31.255.33/31 | default | 1500 | false | - | - |
| Ethernet11 | P2P_LINK_TO_EMEA_NORTH_01_SPINE2_Ethernet5 | routed | - | 172.31.255.35/31 | default | 1500 | false | - | - |
...
interface Ethernet12
   description MLAG_PEER_EMEA_NORTH_01_LEAF3B_Ethernet12
   no shutdown
   channel-group 12 mode active
!
interface Ethernet13
   description MLAG_PEER_EMEA_NORTH_01_LEAF3B_Ethernet13
   no shutdown
   channel-group 12 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel12 | MLAG_PEER_EMEA_NORTH_01_LEAF3B_Po12 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel12
   description MLAG_PEER_EMEA_NORTH_01_LEAF3B_Po12
   no shutdown
   switchport
...
router bgp 65103
   ...
   neighbor 10.255.254.9 description EMEA_NORTH_01_LEAF3B
   neighbor 172.31.255.32 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.32 description EMEA_NORTH_01_SPINE1_Ethernet5
   neighbor 172.31.255.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.34 description EMEA_NORTH_01_SPINE2_Ethernet5
