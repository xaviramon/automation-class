...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.1.15/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| EMEA_NORTH_02_LEAF2 | Vlan4094 | 10.255.252.4 | Port-Channel12 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | TENANT_B_SRV1_POD2_Eth2 | *trunk | *200-299 | *- | *- | 5 |
| Ethernet12 | MLAG_PEER_EMEA_NORTH_02_LEAF2A_Ethernet12 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 12 |
| Ethernet13 | MLAG_PEER_EMEA_NORTH_02_LEAF2A_Ethernet13 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 12 |
...
!
interface Ethernet5
   description TENANT_B_SRV1_POD2_Eth2
   no shutdown
   channel-group 5 mode active
!
interface Ethernet12
   description MLAG_PEER_EMEA_NORTH_02_LEAF2A_Ethernet12
   no shutdown
   channel-group 12 mode active
!
interface Ethernet13
   description MLAG_PEER_EMEA_NORTH_02_LEAF2A_Ethernet13
   no shutdown
   channel-group 12 mode active
```
...
| Port-Channel12 | MLAG_PEER_EMEA_NORTH_02_LEAF2A_Po12 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel12
   description MLAG_PEER_EMEA_NORTH_02_LEAF2A_Po12
   no shutdown
   switchport
