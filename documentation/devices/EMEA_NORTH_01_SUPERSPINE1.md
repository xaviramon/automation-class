...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.1/24 | 192.168.200.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_EMEA_NORTH_01_SPINE1_Ethernet1 | routed | - | 172.16.11.0/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_EMEA_NORTH_01_SPINE2_Ethernet1 | routed | - | 172.16.11.2/31 | default | 1500 | false | - | - |
...
!
interface Ethernet2
   description P2P_LINK_TO_EMEA_NORTH_01_SPINE2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
| -------- | --------- | --- |
| 172.16.11.1 | 65100 | default |
| 172.16.11.3 | 65100 | default |
...
router bgp 65001
   ...
   neighbor 172.16.11.1 remote-as 65100
   neighbor 172.16.11.3 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.11.3 remote-as 65100
