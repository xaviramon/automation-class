...
| --------- | --------------- | ------------ | --------- |
| EMEA_NORTH_01_LEAF2 | Vlan4094 | 10.255.252.5 | Port-Channel12 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | TENANT_B_SRV1_POD1_Eth1 | *trunk | *200-299 | *- | *- | 5 |
| Ethernet12 | MLAG_PEER_EMEA_NORTH_01_LEAF2B_Ethernet12 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 12 |
| Ethernet13 | MLAG_PEER_EMEA_NORTH_01_LEAF2B_Ethernet13 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 12 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet10 | P2P_LINK_TO_EMEA_NORTH_01_SPINE1_Ethernet3 | routed | - | 172.31.255.17/31 | default | 1500 | false | - | - |
| Ethernet11 | P2P_LINK_TO_EMEA_NORTH_01_SPINE2_Ethernet3 | routed | - | 172.31.255.19/31 | default | 1500 | false | - | - |
...
!
interface Ethernet5
   description TENANT_B_SRV1_POD1_Eth1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet10
   description P2P_LINK_TO_EMEA_NORTH_01_SPINE1_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet11
   description P2P_LINK_TO_EMEA_NORTH_01_SPINE2_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet12
   description MLAG_PEER_EMEA_NORTH_01_LEAF2B_Ethernet12
   no shutdown
   channel-group 12 mode active
!
interface Ethernet13
   description MLAG_PEER_EMEA_NORTH_01_LEAF2B_Ethernet13
   no shutdown
   channel-group 12 mode active
```
...
| Port-Channel12 | MLAG_PEER_EMEA_NORTH_01_LEAF2B_Po12 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel12
   description MLAG_PEER_EMEA_NORTH_01_LEAF2B_Po12
   no shutdown
   switchport
...
| 150 | 192.168.255.7:10150 | 10150:10150 | - | - | learned |
| 160 | 192.168.255.7:55160 | 55160:55160 | - | - | learned |
...
| 250 | 192.168.255.7:20250 | 20250:20250 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Common_VRF_Services | 192.168.255.7:10 | connected |
| Tenant_A_APP_Zone | 192.168.255.7:12 | connected |
| Tenant_A_DB_Zone | 192.168.255.7:130 | connected |
| Tenant_A_WAN_Zone | 192.168.255.7:14 | connected |
| Tenant_A_WEB_Zone | 192.168.255.7:11 | connected |
| Tenant_B_OP_Zone | 192.168.255.7:2000 | connected |
...
router bgp 65102
   ...
   neighbor 10.255.254.5 description EMEA_NORTH_01_LEAF2B
   neighbor 172.31.255.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.16 description EMEA_NORTH_01_SPINE1_Ethernet3
   neighbor 172.31.255.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.18 description EMEA_NORTH_01_SPINE2_Ethernet3
